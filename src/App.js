      ...
      <View as="header" padding="10px" backgroundColor="var(--amplify-colors-white)">
        <Flex direction="row" justifyContent="space-around" alignItems="center">
          ...
          <Heading level={4} textAlign="center">
            Welcome to Converge Banking - Verified Permisisons Demo
          </Heading>
              ...
              <TabItem title="Action simulation">
                <Grid templateColumns="1fr 1fr">
                  <View textAlign="left">
                    ...
                    <TextField padding="10px" onChange={e => storeId = e.target.value} placeholder="Location Id eg. US-East" label="Enter Converge Support Identifier" /><br/>
                    ...
                    <Expander type="multiple" defaultValue={['line-1','line-2','line-3']}>
                      ...
                      <div>
                        <ExpanderItem title="Customer role type actions" value="line-1">
                          <Text textAlign="left" variation="info">Customers can search for Cases, Assign & Update Cases and Close Completed Service Requests. </Text><br/>
                          <Button onClick={() => getData('/pets', 'GET')}>Search or View Cases</Button>
                          <Button onClick={() => getData('/order/create', 'POST')}>Create or Update Case</Button>
                          <Button onClick={() => getData('/order/get/order-1', 'GET')}>Close Case</Button>
                        </ExpanderItem>
                      </div>
                      ): null}
                      ...
                      <div>
                        <TextField onChange={e => storeId = e.target.value} placeholder="Location Id eg. US-East" label="Enter Converge Support Identifier" /><br/>
                        <Divider orientation="horizontal" />
